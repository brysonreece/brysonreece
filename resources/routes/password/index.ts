...
* @route 'https://bryson.test/forgot-password'
*/
...
request.definition = {
    methods: ["get","head"],
    url: 'https://bryson.test/forgot-password',
...
* @route 'https://bryson.test/settings/password'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: 'https://bryson.test/settings/password',
} satisfies RouteDefinition<["get","head"]>
