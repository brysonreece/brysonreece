...
export function Welcome() {
  ...
  return (
    <div>
      ...
      <div className="bg-stone-200 dark:bg-stone-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
        <div>
          <div className="flex items-center">
            <svg
              ...
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              className="w-6 h-6 stroke-stone-400"
            >
              <path
                strokeLinecap="round"
            ...
            <h2 className="ml-3 text-xl font-semibold text-stone-900 dark:text-white">
              <a href="https://laravel.com/docs" target="_blank" rel="noopener noreferrer">Documentation</a>
            </h2>
          </div>

          <p className="mt-4 text-stone-500 dark:text-stone-400 text-sm leading-relaxed">
          ...
          <p className="mt-4 text-sm">
            <a
              ...
              className="inline-flex items-center font-semibold text-blue-700 dark:text-blue-300"
            >
              Explore the documentation
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                className="ml-1 w-5 h-5 fill-blue-500 dark:fill-blue-200"
              >
                <path
                  fillRule="evenodd"
