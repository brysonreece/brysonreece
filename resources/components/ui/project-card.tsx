            ...
            >
                ...
                >
                    <CardContent className="relative h-full w-full px-0">
                        ...
                        <div className="absolute inset-0 rounded-lg bg-black/35 dark:bg-black/75" />
                        <div className="absolute top-4 left-4 max-w-3/4">
                            <p className="text-accent dark:text-primary truncate text-xl font-semibold">{year}</p>
                        </div>
                        <div className="absolute right-4 bottom-4 max-w-3/4 text-right">
                            <dt className="text-accent dark:text-primary text-2xl font-semibold">{title}</dt>
                        </div>
                    </CardContent>
                </Card>
