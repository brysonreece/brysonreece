...
import { BookOpen, FolderIcon, GlobeIcon, LayoutGrid, Menu, Search } from 'lucide-react';
                        ...
                        <Sheet>
                            ...
                            <SheetContent side="left" className="bg-sidebar flex h-full w-64 flex-col items-stretch justify-between">
                                ...
                                <SheetHeader className="flex justify-start text-left">
                                    <AppLogoIcon className="size-6 fill-transparent stroke-black dark:stroke-white" />
                                </SheetHeader>
