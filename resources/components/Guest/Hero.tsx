...
export function Hero() {
    return (
        <Container className="text-center pb-16 pt-12 sm:pt-24 xl:pt-48">
            <img
            ...
            <h1 className="mx-auto mt-12 max-w-4xl font-display text-5xl font-bold tracking-tight text-stone-900 dark:text-stone-400 sm:text-7xl">
                ...
                <span className="relative whitespace-nowrap text-blue-600">
                    <svg
                        viewBox="0 0 418 42"
                        className="absolute top-2/3 mt-1 left-0 h-[0.58em] w-full fill-stone-300/70 dark:fill-stone-700/70"
                    ...
                    <span className="relative bg-gradient-to-r from-blue-500 dark:from-blue-400 via-purple-500 dark:via-purple-400 to-pink-500 dark:to-pink-400 bg-clip-text text-transparent">
                        Bryson Reece
                    </span>
                </span>
            </h1>
