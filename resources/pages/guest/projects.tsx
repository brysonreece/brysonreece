    ...
    return (
        <>
            ...
            <Container className="mb-16 max-w-6xl">
                ...
                <ul role="list" className="mb-24 grid grid-cols-1 items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
...
Projects.layout = (page: ReactNode) => <GuestLayout>{page}</GuestLayout>;
