...
function Base({ className, ...props}: SVGAttributes<SVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={cn("h-6 w-6 fill-stone-500", className)} aria-hidden="true" {...props} />
    )
}
