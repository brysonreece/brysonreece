...
Page.description = "An epic tale filled with adventure, dragons, blood, sweat, and tears.";

export async function getStaticProps(): Promise<{ props: { events: CareerEvent[] } }> {
...
export default function Page({ events }: { events: CareerEvent[] }) {
  return (
    <main className="grow">
